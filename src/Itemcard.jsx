    ...
    return (
        <div className='col-lg-4 col-md-6 col-sm-12 mb-4' key={id}>
            <div className='card h-100 shadow-sm border-0 rounded-lg overflow-hidden transition-all duration-300 hover:shadow-lg'>
                <img src={image} className='card-img-top w-full' alt={name}  style={{ height: '300px', objectFit: 'cover' }} onError={(e)=>{
                ...
                <div className="card-body d-flex flex-column p-4">
                    ...
                    <p className='card-text text-muted  mb-3' style={{ fontSize: '0.9rem' }}>{description.sunstring(0,60)}...</p>
