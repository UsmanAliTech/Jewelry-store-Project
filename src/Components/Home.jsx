...
const AnimatedHero = () => {
    ...
    return (
        <div className="hero-banner d-flex align-items-center justify-content-center text-center text-white">
            <Container>
                <animated.h1 style={props} className="display-1 fw-light mb-4">
                    Timeless Elegance. Modern Craft.
                </animated.h1>
                <animated.p style={props} className="lead mb-5">
                    Discover the Jewellux Signature Collection.
                </animated.p>
                <animated.div style={props}>
                    <Button variant="outline-light" size="lg" className="hero-cta-btn">
                        Explore Now
                    </Button>
                </animated.div>
            </Container>
        ...
        <Col md={4} className="mb-4">
            <Card className="collection-card border-0 rounded-0 shadow-sm overflow-hidden" onClick={() => window.location.href = link}>
                <div className="card-img-wrapper">
                    <Card.Img variant="top" src={image} className="card-img-zoom" alt={title} />
                </div>
                <Card.Body className="text-center p-4">
                    <Card.Title className="h5 fw-normal">{title}</Card.Title>
                    <Button variant="link"  className="text-dark p-0 mt-2 shop-link">Shop Collection →</Button>
                </Card.Body>
            </Card>
        </Col>
    );
  ...
  return (
    <div className='Home-container'>
      ...
      <Container className="my-5 py-5">
        <h2 className="text-center mb-5 display-4 fw-light">Featured Collections</h2>
        <Row>
      ...
      <div className="about-snippet-block py-5 mb-5">
        <Container>
          <Row className="align-items-center">
            ...
            <Col md={6} className="p-5">
              <h3 className="display-4 fw-light mb-4">The Art of Fine Jewelry</h3>
              ...
              <Button variant="dark" className="mt-4 rounded-0 about-cta-btn">
                Our Story
              </Button>
            </Col>
          </Row>
